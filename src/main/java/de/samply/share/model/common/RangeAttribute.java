 ...
 *         &lt;element ref="{http://schema.samply.de/common/Value}LowerBound"/&gt;
 *         &lt;element ref="{http://schema.samply.de/common/Value}UpperBound"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "RangeAttribute", namespace = "http://schema.samply.de/common/RangeAttribute")
public class RangeAttribute
  ...
  @XmlElement(name = "LowerBound", namespace = "http://schema.samply.de/common/Value", required = true)
  protected String lowerBound;
  @XmlElement(name = "UpperBound", namespace = "http://schema.samply.de/common/Value", required = true)
