 ...
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://schema.samply.de/common/Entity}Entity"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://schema.samply.de/common/Case}Case" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{http://schema.samply.de/common/Sample}Sample" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "Patient", namespace = "http://schema.samply.de/common/Patient", propOrder = {
    "caseCommon",
    "sample"
})
...
public class Patient
  ...
  @XmlElement(name = "Case", namespace = "http://schema.samply.de/common/Case")
  protected List<Case> caseCommon;
  @XmlElement(name = "Sample", namespace = "http://schema.samply.de/common/Sample")
  ...
  public List<Case> getCase() {
    if (caseCommon == null) {
      caseCommon = new ArrayList<Case>();
    }
    return this.caseCommon;
  }
