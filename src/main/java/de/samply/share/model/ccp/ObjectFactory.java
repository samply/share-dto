 ...
 * generated in the de.samply.share.model.ccp package.
...
public class ObjectFactory {
  ...
  private static final QName _MdrKey_QNAME = new QName("http://schema.samply.de/ccp/MdrKey",
      "MdrKey");
  private static final QName _Inquiry_QNAME = new QName("http://schema.samply.de/ccp/Inquiry",
      "Inquiry");
  private static final QName _Contact_QNAME = new QName("http://schema.samply.de/ccp/Inquiry",
      "Contact");
  private static final QName _Info_QNAME = new QName("http://schema.samply.de/ccp/Inquiry", "Info");
  private static final QName _Value_QNAME = new QName("http://schema.samply.de/ccp/Value", "Value");
  private static final QName _LowerBound_QNAME = new QName("http://schema.samply.de/ccp/Value",
      "LowerBound");
  private static final QName _UpperBound_QNAME = new QName("http://schema.samply.de/ccp/Value",
      "UpperBound");
  private static final QName _QueryResult_QNAME = new QName(
      "http://schema.samply.de/ccp/QueryResult", "QueryResult");
  private static final QName _Patient_QNAME = new QName("http://schema.samply.de/ccp/Patient",
      "Patient");
  private static final QName _Container_QNAME = new QName("http://schema.samply.de/ccp/Container",
      "Container");
  private static final QName _Entity_QNAME = new QName("http://schema.samply.de/ccp/Entity",
      "Entity");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: de.samply.share.model.ccp
   */
   ...
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/Inquiry", name = "Inquiry")
   ...
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/Inquiry", name = "Contact")
   ...
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/Inquiry", name = "Info")
   ...
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/QueryResult", name = "QueryResult")
   ...
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/Patient", name = "Patient")
   ...
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/Entity", name = "Entity")
   ...
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/Container", name = "Container")
   ...
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/MdrKey", name = "MdrKey")
   ...
   * Create an instance of {@link JAXBElement }{@code <}{@link String }{@code >}}.
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/Value", name = "LowerBound", substitutionHeadNamespace = "http://schema.samply.de/ccp/Value", substitutionHeadName = "Value")
   ...
   * Create an instance of {@link JAXBElement }{@code <}{@link String }{@code >}}.
   */
  @XmlElementDecl(namespace = "http://schema.samply.de/ccp/Value", name = "UpperBound", substitutionHeadNamespace = "http://schema.samply.de/ccp/Value", substitutionHeadName = "Value")
