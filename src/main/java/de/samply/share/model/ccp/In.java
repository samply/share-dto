 ...
 *       &lt;all&gt;
 *         &lt;element ref="{http://schema.samply.de/ccp/MultivalueAttribute}MultivalueAttribute"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class In implements Serializable {
  ...
  @XmlElement(name = "MultivalueAttribute", namespace = "http://schema.samply.de/ccp/MultivalueAttribute", required = true)
