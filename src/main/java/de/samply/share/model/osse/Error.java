...
@XmlRootElement(name = "Error", namespace = "http://schema.samply.de/osse/Error")
public class Error
    implements Serializable {

  private static final long serialVersionUID = 1L;
  @XmlElement(name = "Description", namespace = "http://schema.samply.de/osse/Error", required = true)
  protected Object description;
  @XmlElement(name = "MdrKey", namespace = "http://schema.samply.de/osse/MdrKey")
  protected List<String> mdrKey;
  @XmlElement(namespace = "http://schema.samply.de/osse/Error")
