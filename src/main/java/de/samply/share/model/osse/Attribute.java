 ...
 *         &lt;element ref="{http://schema.samply.de/osse/Value}Value"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "Attribute", namespace = "http://schema.samply.de/osse/Attribute")
public class Attribute
  ...
  @XmlElementRef(name = "Value", namespace = "http://schema.samply.de/osse/Value", type = JAXBElement.class)
   ...
   * @return possible object is {@link JAXBElement }{@code <}{@link String }{@code >} {@link
