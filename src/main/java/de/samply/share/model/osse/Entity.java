...
@XmlType(name = "Entity", namespace = "http://schema.samply.de/osse/Entity", propOrder = {
    "attribute",
    "container",
    "ref"
})
...
public class Entity
  ...
  @XmlElement(name = "Attribute", namespace = "http://schema.samply.de/osse/Attribute")
  protected List<Attribute> attribute;
  @XmlElement(name = "Container", namespace = "http://schema.samply.de/osse/Container")
