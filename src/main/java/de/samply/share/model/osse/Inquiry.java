 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://schema.samply.de/osse/Query}Query"/&gt;
 *         &lt;element name="ExposeURL" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *         &lt;element name="Author" type="{http://schema.samply.de/osse/Inquiry}contact"/&gt;
...
@XmlType(name = "Inquiry", namespace = "http://schema.samply.de/osse/Inquiry", propOrder = {
    "query",
    "exposeUrl",
    "author",
    "label",
...
public class Inquiry
  ...
  @XmlElement(name = "Query", namespace = "http://schema.samply.de/osse/Query", required = true)
