 ...
 *       &lt;all&gt;
 *         &lt;element ref="{http://schema.samply.de/osse/RangeAttribute}RangeAttribute"/&gt;
 *       &lt;/all&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Between implements Serializable {
  ...
  @XmlElement(name = "RangeAttribute", namespace = "http://schema.samply.de/osse/RangeAttribute", required = true)
